...
${OBJECTDIR}/Hacker_Practice_5_1.o: Hacker_Practice_5_1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_1.o Hacker_Practice_5_1.cpp

${OBJECTDIR}/Hacker_Practice_5_2.o: Hacker_Practice_5_2.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_2.o Hacker_Practice_5_2.cpp

${OBJECTDIR}/Hacker_Practice_5_3.o: Hacker_Practice_5_3.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_3.o Hacker_Practice_5_3.cpp

${OBJECTDIR}/Hacker_Practice_5_4.o: Hacker_Practice_5_4.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_4.o Hacker_Practice_5_4.cpp

${OBJECTDIR}/Hacker_Practice_5_5.o: Hacker_Practice_5_5.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_5.o Hacker_Practice_5_5.cpp

${OBJECTDIR}/Hacker_Practice_5_6.o: Hacker_Practice_5_6.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hacker_Practice_5_6.o Hacker_Practice_5_6.cpp
